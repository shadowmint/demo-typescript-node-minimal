...
$.when($.ajax("/my/page.json")).then(function (a) {
    return a.asdf;
}); // is type JQueryPromise<any>
$.when($.ajax("/my/page.json")).then(function (a, b, c) {
    return a.asdf;
}); // is type JQueryPromise<any>
$.when("asdf", "jkl;").done(function (x, y) {
...
var f1 = $.when("fetch");
var f2 = f1.then(function (s) {
    return [s, s];
});
var f3 = f2.then(function (v) {
    return 3;
});
